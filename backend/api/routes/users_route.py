...
from modules.user.user_dto import UserCreate, UserRead, UserUpdate
...
async def update_password(user_id: UUID , new_password: str, db: AsyncSession = Depends(get_db)):
    """
